...
<div class="flex items-center mt-9 md:mt-24 ">
  ...
  <h4 class="typo-h5 text-center px-3 md:px-12 md:min-w-[260px] md:px-10 lg:min-w-[350px] text-orange"><?php the_field('heading'); ?></h4>
  <div aria-hidden="true" class="w-full h-[1px] bg-orange"></div>
</div>

<!-- FEATURED CASES -->
<div class="m-auto lg:w-[90%] xl:w-[1220px] relative mt-4 mb-9 md:mb-24 border-2 border-blue">
  <div class="grid h-full gap-2 mx-6 border-2 border-black md:grid-cols-2 lg:grid-cols-3 lg:mx-0">

    <!-- CASE 1 -->
    <div class="relative h-full p-10 bg-gray md:p-14 lg:p-20">
      <img class="border-2 border-red-600 " src="<?php echo wp_get_attachment_image_url($image_1_id, $image_size); ?>" />

      <?php if (!empty($title_1)) : ?>
        <p class=""><?php echo $title_1; ?></p>
      <?php endif; ?>

      <?php if (!empty($customer_1)) : ?>
        <p class=""><?php echo $customer_1; ?></p>
      <?php endif; ?>
    ...
    <!-- CASE 2 -->
    <div class="relative h-full p-10 mb-3 sm:mb-0 bg-gray md:p-14 lg:p-20">
      <img class="border-2 border-red-600" src="<?php echo wp_get_attachment_image_url($image_2_id, $image_size); ?>" />

      <?php if (!empty($title_2)) : ?>
        <p class=""><?php echo $title_2; ?></p>
      <?php endif; ?>

      <?php if (!empty($customer_2)) : ?>
        <p class=""><?php echo $customer_2; ?></p>
      <?php endif; ?>
      ...
      ?>
        <a class="link" href="<?php echo esc_url($link_2_url); ?>" target="<?php echo esc_attr($link_2_target); ?>"> <?php echo esc_html($link_1_title); ?></a>
      <?php endif; ?>
    ...
    <!-- CASE 3 -->
    <div class="relative h-full p-10 mb-3 sm:mb-0 bg-gray md:p-14 lg:p-20">
      <img class="border-2 border-red-600" src="<?php echo wp_get_attachment_image_url($image_3_id, $image_size); ?>" />

      <?php if (!empty($title_3)) : ?>
        <p class=""><?php echo $title_3; ?></p>
      <?php endif; ?>

      <?php if (!empty($customer_3)) : ?>
        <p class=""><?php echo $customer_3; ?></p>
      <?php endif; ?>
